...
pkgs.writeShellScriptBin "zcli" ''
  ...
  # ==================================
  #
  #    Purpose: NixOS system management utility for D3vOS distribution
  #     Author: Don Williams (ddubs) & D3vboi
  ...
  #
  # Variables:
  # PROJECT             - Base directory name (ddubsos/d3vos)
  ...
  print_help() {
    echo "D3vOS CLI Utility -- version $VERSION"
    echo ""
